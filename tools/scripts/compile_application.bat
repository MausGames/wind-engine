...
SET _PARAMETERS_=--strict_mode_input --dependency_mode SORT_ONLY --language_in ECMASCRIPT_2020 --language_out ECMASCRIPT_2015 --js '%~dp0..\..\source\**.js' --js '%~1' --js_output_file %~2
