...
- Pre-built dependencies can be downloaded with the **complete_repository.bat/.sh** script or manually built from the **Wind Library** repository ([GitHub](https://github.com/MausGames/wind-library), [GitLab](https://gitlab.com/MausGames/wind-library)).
